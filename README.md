...
## Environments
- Preview: https://main--adaptto2--balasoiuroxana.aem.page/
- Live: https://main--adaptto2--balasoiuroxana.aem.live/
...
1. Open the `adaptto2` directory in your favorite IDE and start coding :)
